...
if (!('webkitSpeechRecognition' in window)) {
  ...
  if (localStorage['transcript'] === "") {
    document.getElementById("warning").innerHTML = "Select region from the dropdown menu below. <br>Click \"Start Dictation\" and speak the phonetic alphabet as above. <br> When complete click \"Stop listening\" then \"COPY\" then \"SEND\" <br><br><br>For support email: K5NEW at arrl dot net";
  }
